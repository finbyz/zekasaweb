	...
	*/
	...
	make() {
		...
		this.items.forEach(item => {
			...
			html += `<div class="col-lg-4 col-md-6 col-sm-12 item-card p-3"><div class="card text-left card-wrapper">`;
	...
	get_primary_button(item, settings) {
		if (item.has_variants) {
			...
			return `
				...
				<a href="/cart" id="${ item.name }" class="zekasa-button my-2 btn-add-to-cart-list w-100 go-to-cart-grid ${ item.in_cart ? '' : 'hidden' }"
						data-item-code="${ item.item_code }" style="margin-top: 0px !important;">
